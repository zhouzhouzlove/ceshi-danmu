...
static inline float32x4_t simd_divs(float32x4_t a, float32x4_t b)
{
  float32x4_t i_d = simd_rcps(b);
...
static inline float32x4_t simd_selects(float32x4_t a, float32x4_t b, float32x4_t c)
{
  int32x4_t conn = simd_casts_w(a);
  int32x4_t cona = simd_andw(conn, simd_casts_w(c));
  int32x4_t conb = simd_andnotw(conn, simd_casts_w(b));
  int32x4_t con = simd_addw(cona, conb);
